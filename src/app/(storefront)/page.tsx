...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-red-50 via-white to-red-50 py-16 sm:py-24">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-red-500 hover:bg-red-600 text-white text-lg px-8 py-6"
                  asChild
                >
            ...
            <div className="relative">
              <div className="relative aspect-square max-w-md mx-auto">
                <div className="absolute inset-0 bg-gradient-to-br from-red-200 to-red-300 rounded-3xl rotate-3" />
